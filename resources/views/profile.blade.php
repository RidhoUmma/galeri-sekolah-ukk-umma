                            ...
                            <div class="card-body">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <img src="@if (auth()->user()->role === 'admin') assets/assets/theme/images/user/9.jpg @elseif(auth()->user()->role === 'user') assets/assets/theme/images/user/logok.png @else <!-- Handle other roles if needed --> @endif" class="rounded-circle" style="margin-bottom: 10px;" height="100" width="100" alt="Admin Image">
                                        </div>
                                        <hr/>
                                        <div class="col-md-6">
