...
<head>
    ...
    <title>Chasir</title>
    <!-- Favicon icon -->
    <link rel="icon" type="image/png" sizes="16x16" href="/assets/assets/theme/images/favicon.png">
    <!-- Custom Stylesheet -->
        ...
        ***********************************-->
        <div class="nav-header">
            <div class="brand-logo">
                <a href="index.html">
                    {{-- <b class="logo-abbr"><img src="/assets/assets/theme/images/logo.png" alt=""> </b> --}}
                    <span class="logo-compact"><img src="/assets/assets/theme/images/logo-compact.png" alt=""></span>
                    <span class="brand-title">
                        {{-- <img src="/assets/assets/theme/images/logo-text.png" alt=""> --}}
                    </span>
                </a>
            </div>
        </div>
                        ...
                        <li class="icons dropdown">
                            <div class="user-img c-pointer position-relative" data-toggle="dropdown">
                                ...
                                @elseif(auth()->user()->role === 'kasir')
                                    <span style="margin-right: 10px;">Kasir</span>
                                @else
                                    <!-- Handle other roles if needed -->
                                @endif
                                <span class="activity active"></span>
                                <img src="assets/theme/images/user/logok.png" height="40" width="40" alt="">
                            </div>
        ...
        <div class="nk-sidebar">
            <div class="nk-nav-scroll">
                <ul class="metismenu" id="menu">
                    ...
                    {{-- <li>
                        <a href="#" aria-expanded="false">
                            <i class="icon-speedometer menu-icon"></i><span class="nav-text">Seting Diskon</span>
                        </a>
                    </li>
                                    ...
                                    <table class="table table-striped table-bordered zero-configuration">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>Edinburgh</td>
                                                <td>
                                                    <a href="#" class="btn btn-x5 btn-primary"><i class="fa fa-edit"></i>Edit</a>
                                                    <a href="#" class="btn btn-x5 btn-danger"><i class="fa fa-trash"></i>Hapus</a>
